      ...
      <div className="container">
        <div className="row">
          ...
          <div className="col-md-4 mb-4">
            <h3 className="fw-bold text-primary"><i className="bi bi-shop me-2 fs-1"></i> Mahesh Mart</h3>
...
<i class="bi bi-arrow-right me-1"></i>Terms & Conditions
          ...
          <div className="col-md-4 mb-4">
            ...
            <hr />
            <p>Email: maheshthummanani@gmail.com</p>
            <p>Phone: +91 7680943067</p>
            <p>Address: Ameerpet, Main Road,near Sathyam Mall Hyderabad, Telangana, India</p>
        ...
        <div className="text-center mt-3">
          &copy; {new Date().getFullYear()} MaheshMart. All rights reserved.
        </div>
      </div>
    </footer>
  );
